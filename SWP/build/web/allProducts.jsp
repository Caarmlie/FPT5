            ...
            <article>
                ...
                <section class="section food-menu" id="food-menu">
                    <div class="container">
                        ...
                        <ul class="fiter-list">
                            <li><a href="allproduct" class="all" data-filter="all"><h5>Tất cả</h5></a></li>
                                <c:forEach items="${listC}" var="o">
                                <li><a href="category?cid=${o.cid}" class="javascript" data-filter="javascript">
                                        <h5>${o.cname}</h5>
                                    </a></li>
                                </c:forEach>
                        </ul>
                        <div class="row justify-content-center">
                            <form action="search" method="post" class="searchForm col-sm-6">
                                <input oninput="searchByName(this)" name="txt" type="text" id="searchBar" placeholder="Nhập tên món bạn muốn">
                            </form>
                        </div>
                                    ...
                                    <div class="food-menu-list">
                                        <div class="food-menu-card">
                                            ...
                                            <div class="card-banner">
                                                <img class="img-responsive" src="assets/images/${o.img}" width="300" height="300" loading="lazy"
                                                     alt="${o.pname}" class="w-100">
