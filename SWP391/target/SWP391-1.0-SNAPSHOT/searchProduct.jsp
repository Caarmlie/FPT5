...
<!--          <div class="row">
                        <div class="col-12">
                            <ul class="filter-list">
                                <li><a href="searchProduct" class="all" data-filter="all">All</a></li>
                                <c:forEach items="${listC}" var="o">
                                <li><a href="category?cid=${o.CateID}" class="javascript" data-filter="javascript">${o.CateName}</a></li>
                                </c:forEach>
                        </ul>
                    </div>-->
                ...
                <div id="content" class="row">
                    <c:forEach items="${listP}" var="o">
                        <div class="product col-sm-4">
                            <a href="view_car_detail?pid=${o.pID}">
                                <div class="product-card">
                                    <div class="card-thumbnail">
                                        <img class="img-responsive" src="/images/${o.pImage}">
                                    </div>
                                    <div class="card-content">
                                        <div class="order-btn">
                                            <a class="order-btn-text" href="view_car_detail?pid=${o.pID}"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                        </div>
                                        <h1 class="card-title">
                                            ${o.pName}
                                        </h1>
                                        <div class="description">
                                            <ul>
                                                <li>
                                                    ...
                                                    <span>
                                                        <span class="attri">${o.Detail}</span> </span>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="price">
